 ...
 * @author Asus
 */
public class lingkaranLatihanSoal5 extends javax.swing.JPanel implements interfaceBangunDatar {
    ...
    public void jawaban() {
        ...
        if(jawaban.equals("78.5")){
            jTextField2.setText("Jawaban Benar : 78.5 cm");
        }else if(jawaban.equals("78.5 cm")){
            jTextField2.setText("Jawaban Benar : 78.5 cm");
        } else {
