 ...
 * @author SONY
 */
public class bolaLatihanSoal2 extends javax.swing.JPanel implements interfaceBangunRuang {

    /**
     * Creates new form bolaLatihanSoal2
     */
    String jawaban;
    
    public bolaLatihanSoal2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Bola/Latsol Bola 2.png"))); // NOI18N
        add(jLabel1);
    ...
    public void bangunRuang() {
        ...
        if(jawaban.equals("11498.67")){
            jTextField2.setText("Jawaban Benar : 11498.67 cm kubik");
        } else {
